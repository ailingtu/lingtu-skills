...
- Accepts a public TikTok, Douyin (抖音), Xiaohongshu (小红书), WeChat Channels (视频号), YouTube, or Instagram URL, a local video file path, or a Lingtu material/file reference (`businessId` + `businessType`).
