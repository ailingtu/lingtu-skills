...
PACKAGE_NAMES=("Content Create - 商品图、参考图、电商视频、爆款复刻" "TKShop Query - TK 店铺数据查询和经营分析" "TikTok Monitor - TikTok 达人/竞品监控和内容情报分析" "Video Understand - 视频理解、内容分析与复刻提示词生成" "TK Blacklist - TK 达人黑名单查询")
